...
#endif
#endif
    ssize_t mbed_write(int fildes, const void *buf, size_t nbyte);
    ssize_t mbed_read(int fildes, void *buf, size_t nbyte);
    off_t lseek(int fildes, off_t offset, int whence);
    int isatty(int fildes);
    int fsync(int fildes);
    int fstat(int fildes, struct stat *st);
    int fcntl(int fildes, int cmd, ...);
    int mbed_poll(struct pollfd fds[], nfds_t nfds, int timeout);
    int mbed_open(const char *name, int oflag, ...);
    int mbed_close(int fildes);
